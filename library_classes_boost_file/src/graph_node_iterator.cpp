...
Graph_Node_Iterator::Graph_Node_Iterator(boost::container::vec_iterator<bi::offset_ptr<node_unique_ptr_type>, false> begin_input, boost::container::vec_iterator<bi::offset_ptr<node_unique_ptr_type>, false> end_input, size_t thread_count){
    begin = begin_input;
    end = end_input;
...
boost::container::vec_iterator<bi::offset_ptr<node_unique_ptr_type>, false> Graph_Node_Iterator::get_begin(){
    return begin;
}

boost::container::vec_iterator<bi::offset_ptr<node_unique_ptr_type>, false> Graph_Node_Iterator::get_end(){
    return end;
}

const std::vector<size_t>& Graph_Node_Iterator::get_thread_limits(){
    return thread_limits;
}

const std::vector<u_int64_t>& Graph_Node_Iterator::get_prime_numbers(){
